# Data Governance (Global: GDPR, CCPA, PDPA SG/ID)
...
- Consent & lawful basis: for production, ensure explicit consent for tracking where required. Align with EU (GDPR), California (CCPA), and SE Asia (PDPA SG/ID) guidelines regarding cookie consent and opt-ins.
